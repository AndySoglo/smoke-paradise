...
<head>
    ...
    <title>Register - Smoke Paradise</title>
...
<body class="bg-gray-900 flex items-center justify-center min-h-screen font-sans">
    ...
    <div class="w-full max-w-md bg-gray-800 rounded-3xl shadow-2xl p-8">
        ...
        <div class="flex justify-center mb-6">
            <div class="w-20 h-20 rounded-full bg-gray-900 flex items-center justify-center shadow-lg overflow-hidden">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-input-error :messages="$errors->get('name')" class="mt-2 text-orange-500 text-sm" />
            </div>
            ...
            <div>
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                    class="w-full px-4 py-3 rounded-xl bg-gray-700 text-white placeholder-gray-400 focus:ring-orange-500 focus:border-orange-500 border border-gray-600 outline-none" />
                <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-orange-500 text-sm" />
            </div>

            <!-- Actions -->
            <div class="flex items-center justify-between">
                <a href="{{ route('login') }}" class="text-sm text-orange-400 hover:text-orange-300 underline">
                    Already registered?
                </a>
