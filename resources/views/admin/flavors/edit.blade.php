...
<div class="max-w-md mx-auto">
    <h1 class="text-3xl font-bold mb-8 text-gray-800">Modifier l'arôme</h1>

    <form method="POST" action="{{ route('admin.flavors.update', $flavor) }}"
        ...
        <div>
            ...
            <input name="name" value="{{ old('name', $flavor->name) }}" placeholder="Nom de l'arôme"
